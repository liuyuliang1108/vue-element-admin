<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-form-item prop="ttamp">
        <span class="svg-container">
          <svg-icon icon-class="user" />
        </span>
        <el-input
          ref="ttamp"
          v-model="loginForm.ttamp"
          placeholder="Username"
          name="ttamp"
          type="text"
          tabindex="1"
      ...
      <el-form-item prop="sture">
        <span class="svg-container">
          <svg-icon icon-class="user" />
        </span>
        <el-input
          ref="sture"
          v-model="loginForm.sture"
          placeholder="Username"
          name="sture"
          type="text"
          tabindex="1"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loading: false,
      showDialog: false,
      redirect: undefined,//重定向地址 从路由获取
      otherQuery: {},
    }
  },
  watch: {
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          var _this = this;
          var param = {
            'ttamp': _this.loginForm.ttamp,
            'sture': _this.loginForm.sture,
